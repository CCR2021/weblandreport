...
def get_data_for_district_code(appl_no, status, dist_code):
    ...
    try:
        ...
        if data_list:
            ...
            logging.error(f"No data found for application number {appl_no}")
            return {}, "No Data", "No Data"

    except requests.exceptions.RequestException as e:
        logging.error(f"Request error for application number {appl_no}: {e}")
        return {}, "No Data", "No Data"

    except Exception as e:
        logging.error(f"An error occurred for application number {appl_no}: {e}")
        return {}, "No Data", "No Data"
